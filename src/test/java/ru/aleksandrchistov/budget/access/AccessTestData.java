...
public class AccessTestData {
    ...
    public static final User admin = new User(ADMIN_ID, "Иванов Иван Иванович", "admin@yandex.ru", "admin", Role.ADMIN);
    public static final User manager = new User(MANAGER_ID, "Петров Петр Петрович", "manager@yandex.ru", "manager", Role.MANAGER);
    public static final User analyst = new User(ANALYST_ID, "Маринова Марина Мариновна", "analyst@yandex.ru", "analyst", Role.ANALYST);

    public static User getNew() {
        return new User(null, "Самый Новый Пользователь", "user@yandex.ru", "user", Role.ANALYST);
    }
